...
import com.fyp.privacyguard.GlideApp;
...
public class ListActivity extends AppCompatActivity {
    ...
    private void triggerSort() {
        mDialog = new AlertDialog.Builder(ListActivity.this)
        ...
        if (!DataManager.getInstance().hasPermission(getApplicationContext())) {
            mSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                    if (b) {
                        Intent intent = new Intent(ListActivity.this, AppService.class);
...
//        return getResources().getStringArray(R.array.sort)[sortInt];
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
//            case R.id.settings:
//                startActivityForResult(new Intent(ListActivity.this, SettingsActivity.class), 1);
//                return true;
            case R.id.sort:
                triggerSort();
                return true;
    ...
    class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(MyViewHolder holder, int position) {
            ...
            GlideApp.with(ListActivity.this)
                    .load(AppUtil.getPackageIcon(ListActivity.this, item.mPackageName))
            ...
            void setOnClickListener(final AppItem item) {
                itemView.setOnClickListener(view -> {
                    ...
                    ActivityOptionsCompat options = ActivityOptionsCompat.
                            makeSceneTransitionAnimation(ListActivity.this, mIcon, "profile");
